...
class Ui_MainWindowForm(object):
    def setupUi(self, MainWindowForm):
        ...
        self.actionLicense = QtWidgets.QAction(MainWindowForm)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/offset_check/icons/key-16.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLicense.setIcon(icon8)
    ...
    def retranslateUi(self, MainWindowForm):
        ...
        self.actionLicense.setText(_translate("MainWindowForm", "License"))
import resources_rc
